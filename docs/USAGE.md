...
|---|---|---|---|---|---|---|---|
| 51,6 % | 65,9 % | 80,2 % | 94,5 % | 100 % | | 23,1 % | 37,4 % |

Пятнице здесь достаётся её утро: сброс стоит в конце этих суток, и план в её
строке доходит ровно до 100 % — ряд от понедельника до пятницы читается сверху
вниз. Суббота с воскресеньем в этом окне уже прошли (они идут сразу за
сбросом), поэтому уходят под черту в конец ряда — их проценты не обвал плана,
а начало той же недели. Порядок от момента не зависит: строки стоят на своих
местах всю неделю, меняется только подсвеченная.
