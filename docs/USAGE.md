...
Ряд дней целиком можно выключить — в настройках, вкладка **Панель**, галкой
**«Дневной план»**. На месте семи полос с синей плановой зоной и парой чисел
«факт / план» встаёт одна полоса на всю неделю: тот же вид, что у пятичасовой
сессии, — голый процент без сравнения с графиком. Панель короче ровно на
разбивку по суткам; выбор «Вся неделя / Только сегодня» в этом виде смысла не
имеет и скрывается вместе с ней.

Заливка этой полосы, в отличие от суточных, краснеет на критическом пороге —
границе, за которой нет плановой зоны рядом, которая на дейтеранопии
...
| Дневной план | выключенный убирает ряд дней совсем — на его месте одна полоса на всю неделю, как у сессии |
| Суточные полосы | «Вся неделя» — семь строк; «Только сегодня» — одна, а неделя раскрывается кликом по ней, пока панель открыта. Виден только пока дневной план включён |
...
Объяснение, откуда берётся токен, почему вставить свой нельзя и как обойтись
без него вовсе, плюс кнопка «Проверить сейчас»: она делает один настоящий
запрос и печатает результат — процент или причину отказа.
...
Рядом — **«Начать счёт заново»** (см. [Смена аккаунта](#смена-аккаунта)).
...
| `appearance.showsPlan` | `true` | `false` убирает ряд дней совсем — на его месте одна полоса недели без плана, как у сессии; `panelLayout` тогда не смотрят |
