...
Две круглые кнопки в заголовке выбирают Claude или Codex. Они не выполняют
вход и не меняют аккаунт внутри клиентов — только показывают лимиты уже
авторизованного сервиса. Последний выбор запоминается. У каждого сервиса свой
