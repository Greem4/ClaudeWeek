...
Переключатель в заголовке выбирает Claude или Codex: две кнопки со знаками
самих сервисов в общей рамке, выбранная подсвечена подложкой и чёрточкой под
знаком. Кнопки не выполняют вход и не меняют аккаунт внутри клиентов — только
