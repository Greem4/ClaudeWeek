...
| `AccountPicker.swift` | переключатель Claude/Codex в заголовке: знаки сервисов из ресурсного бандла (`Sources/ClaudeWeekApp/Assets`), крашенные как шаблонные под тему. Выбор поступает из `Config.activeAccount`, собственного расходящегося состояния нет |
