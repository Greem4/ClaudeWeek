...
- **Настройка «Дневной план»** на вкладке «Панель»: выключает семь суточных
  полос с планом и парой чисел «факт / план», оставляя одну полосу на всю
  неделю — тот же вид, что у пятичасовой сессии, голый процент без сравнения
  с графиком. Панель короче ровно на разбивку по суткам. Заливка этой полосы
  (и заодно полосы пятичасовой сессии — раньше у неё заливка на красный
  порог не реагировала вовсе) теперь краснеет на критическом пороге: рядом с
  ней нет плановой зоны, с которой красный сливался бы на дейтеранопии, —
  та причина, по которой суточные полосы заливку красным не красят,
  здесь не применима.
