...
- Настройка **«Начало недели»**: ряд суток на панели идёт либо с понедельника
  (по умолчанию), либо с дня сброса, как раньше. При понедельнике пятнице
  достаётся её утро — план в её строке доходит ровно до 100 %, — а суббота с
  воскресеньем, прошедшие сразу после сброса, уходят под черту в конец ряда.
  Цифры и границы окна настройка не трогает: двигается только порядок строк.
