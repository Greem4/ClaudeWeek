...
enum Screenshot {
    ...
    static func render(into directory: URL, config: Config) -> Int32 {
        ...
        // Единственное отступление от заводского вида: недельный ряд. Из
        // коробки панель компактная, но картинка в README должна показывать
        // то, ради чего программа написана, — все семь суток разом. Как
        // свернуть панель до сегодняшнего дня, сказано в руководстве.
