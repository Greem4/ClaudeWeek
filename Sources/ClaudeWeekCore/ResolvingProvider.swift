...
public extension CachedUsage {
    ...
    func snapshot(config: Config) -> UsageSnapshot {
        // Рабочие часы — из конфига: без них восстановленный снимок считал бы
        // план по чужому распорядку, и полосы до первого ответа сети
        // расходились бы с теми, что панель показывала минуту назад.
