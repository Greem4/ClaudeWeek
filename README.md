...
- **Неделя с планом** — семь суточных полос: факт, плановая зона, перерасход.
  ...
  Ряд идёт с понедельника, а сутки, прошедшие сразу после сброса, стоят под
  чертой в конце; в настройках его можно развернуть от дня сброса.
...
<p align="center">
  <img src="docs/images/notification-week-dark.png" width="440" alt="Баннер недельного лимита">
  <br>
  <img src="docs/images/notification-session-dark.png" width="440" alt="Баннер пятичасовой сессии">
</p>

В баннере три строки — сколько израсходовано, через сколько сброс и статистика
окна: **с какого дня оно идёт и на какую модель ушло больше всего**. Ту же
сводку показывает картинка, и в развёрнутом уведомлении её видно целиком:
подпись окна, процент, полоса расхода и главная модель под ней.

<p align="center">
  <img src="docs/images/notification-card-week-dark.png" width="120" alt="Карточка недели, тёмная тема">
  <img src="docs/images/notification-card-week-light.png" width="120" alt="Карточка недели, светлая тема">
  <img src="docs/images/notification-card-session-dark.png" width="120" alt="Карточка сессии, тёмная тема">
  <img src="docs/images/notification-card-session-light.png" width="120" alt="Карточка сессии, светлая тема">
</p>

Разбивка у каждого лимита своя: недельная берётся из снимка, а для пятичасовой
сессии считается отдельно — по транскриптам ровно за эти пять часов. Назвать в
разговоре о сессии недельную долю значило бы выдать чужое число за своё.
