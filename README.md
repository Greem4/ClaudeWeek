...
- **Чем потрачено** — клик по цифрам процента открывает окно с разбивкой по
  моделям: доля Opus, Sonnet и Haiku, токены по видам, число ответов. Считается
  по вашим транскриптам: сервер сообщает только итог недели.
