...
Настройка «План считать на» сдвигает опорную точку строки с её конца на
середину рабочего времени — числа в колонке становятся меньше, смысл тот же.
...
- **Темп в футере — то же самое одним числом.** `1.0×` — вровень, `1.4×` —
  при таком темпе лимит кончится раньше сброса, и вторая строка футера
  скажет, во сколько именно. Момент ищется тоже по рабочим часам: обещать
  исчерпание в четыре утра, когда никто не работает, бессмысленно.
...
| План считать на | середину рабочего времени суток или их конец |
| Рабочий день | распорядок из списка (10:00–18:00, 10:00–22:00, 11:00–полночь, 9:00–22:00, круглосуточно) или свои часы степперами; по ним раскладывается недельный лимит, ночью план стоит |
