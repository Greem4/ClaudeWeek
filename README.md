...
<p align="center">
  <img src="docs/images/notification-banners-dark.png" width="560" alt="Два баннера: недельный лимит числом, пятичасовая сессия дугой">
</p>

В баннере две строки — сколько израсходовано и через сколько сброс, — а какой
это лимит, говорит **картинка**, а не третья строка текста: **пятичасовая
сессия приходит дугой, недельный лимит — красным числом**. Тот же язык, что в
строке меню, где дуга по умолчанию отдана сессии, а цифра в центре — неделе.
