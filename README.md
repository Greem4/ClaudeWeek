...
В баннере — лимит и живой процент, остаток и час сброса, а рядом то же кольцо,
что стоит в строке меню, и того же цвета. Три правила держат его нешумным:
...
спрашивается один раз, при первом запуске.
